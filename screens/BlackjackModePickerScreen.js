...
const MODES = [
  {
    ...
    emoji: '🎮',
    label: 'Free Play',
    description: 'Practice with play money. No coins wagered — play as long as you like.',
  },
  {
    id: 'casino',
    emoji: '🪙',
    label: 'Casino',
    description: 'Wager your coin balance. Win big or bust — real stakes, real rewards.',
  },
];
...
export default function BlackjackModePickerScreen({ navigation }) {
  ...
  const startGame = async () => {
    ...
    await promptIfSaved({
      ...
      gameName: 'Blackjack',
      onFresh: () => navigation.navigate('Game', { mode: 'casino', resumeFromSave: false }),
      onResume: () => navigation.navigate('Game', { mode: 'casino', resumeFromSave: true }),
    });
  };
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={styles.subtitle}>Choose your mode, then start a hand.</Text>
