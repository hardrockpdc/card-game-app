...
const styles = StyleSheet.create({
  ...
  scoreName: { color: '#fff', fontSize: scaleFont(15), fontWeight: 'bold', marginBottom: scale(6) },
  scoreBarTrack: { height: scale(8), backgroundColor: '#0d1117', borderRadius: scale(4), marginBottom: scale(4), overflow: 'hidden' },
  scoreBarFill: { height: '100%', backgroundColor: '#4caf50', borderRadius: scale(4) },
  scoreBarFillWinner: { backgroundColor: '#ffd700' },
  scoreCount: { color: '#b0b0c0', fontSize: scaleFont(12), textAlign: 'right' },
  playAgainBtn: { backgroundColor: '#4caf50', paddingHorizontal: scale(48), paddingVertical: scale(18), borderRadius: scale(12), marginBottom: scale(16) },
  playAgainText: { color: '#fff', fontSize: scaleFont(20), fontWeight: 'bold' },
  homeBtn: { backgroundColor: '#16213e', paddingHorizontal: scale(48), paddingVertical: scale(14), borderRadius: scale(12), borderWidth: 1, borderColor: '#334' },
  homeBtnText: { color: '#b0b0c0', fontSize: scaleFont(16) },

  opponentsRow: { paddingHorizontal: scale(12), gap: scale(6), marginBottom: scale(6) },
  opponentCard: { backgroundColor: '#16213e', borderRadius: scale(10), padding: scale(10), borderWidth: 1.5, borderColor: '#334' },
  opponentCardActive: { borderColor: '#e94560' },
  opponentCardMulti: {},
  opponentHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: scale(2) },
  opponentName: { color: '#fff', fontSize: scaleFont(13), fontWeight: 'bold', flex: 1 },
  opponentTurnDot: { color: '#e94560', fontSize: scaleFont(11), marginLeft: scale(4) },
  opponentStats: { color: '#b0b0c0', fontSize: scaleFont(11), marginBottom: scale(2) },
  opponentMeldScroll: { marginTop: scale(2) },

  centerSection: { paddingHorizontal: scale(12), marginBottom: scale(6) },
  pileRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: scale(6) },
  pileBox: { alignItems: 'center', backgroundColor: '#16213e', borderRadius: scale(10), padding: scale(10), minWidth: scale(68) },
  pileLabel: { color: '#b0b0c0', fontSize: scaleFont(11), textTransform: 'uppercase', letterSpacing: scale(1), marginBottom: scale(2) },
  pileCount: { color: '#fff', fontSize: scaleFont(24), fontWeight: 'bold' },
  activeSlotBox: { alignItems: 'center' },
  emptySlot: { width: scale(70), height: scale(100), borderRadius: scale(8), borderWidth: 2, borderColor: '#334', borderStyle: 'dashed', alignItems: 'center', justifyContent: 'center' },
  emptySlotText: { color: '#555', fontSize: scaleFont(20) },
  myProgress: { color: '#4caf50', fontSize: scaleFont(13), textAlign: 'center', marginBottom: scale(2) },
  phaseLabel: { color: '#b0b0c0', fontSize: scaleFont(12), textAlign: 'center' },
  errorMsg: { color: '#e94560', fontSize: scaleFont(13), textAlign: 'center', marginTop: scale(4) },

  meldSection: { paddingHorizontal: scale(12), marginBottom: scale(6) },
  sectionLabel: { color: '#b0b0c0', fontSize: scaleFont(11), textTransform: 'uppercase', letterSpacing: scale(1), marginBottom: scale(4) },
  meldRow: { flexDirection: 'row', gap: scale(6) },
  meldRowWrap: { flexWrap: 'wrap', rowGap: scale(6) },
  meldGroup: { flexDirection: 'row', borderRadius: scale(8), borderWidth: 2, borderColor: 'transparent', padding: scale(2) },
  ...
  selectedWrapper: { borderRadius: scale(10), borderWidth: 3, borderColor: '#4caf50', transform: [{ translateY: -10 }] },
  selectedWrapperSmall: { borderRadius: scale(7), borderWidth: 3, borderColor: '#4caf50', transform: [{ translateY: -8 }] },

  actionBar: { backgroundColor: '#16213e', paddingHorizontal: scale(16), paddingVertical: scale(12), borderRadius: scale(12), marginHorizontal: scale(12), marginTop: scale(6) },
  actionBtnRow: { flexDirection: 'row', gap: scale(8), marginBottom: scale(6), justifyContent: 'center' },
  actionBtn: { backgroundColor: '#4caf50', paddingHorizontal: scale(14), paddingVertical: scale(10), borderRadius: scale(10), alignItems: 'center', justifyContent: 'center', minWidth: scale(90) },
  ...
  actionBtnText: { color: '#fff', fontSize: scaleFont(11), fontWeight: 'bold', textAlign: 'center' },
  hintText: { color: '#666', fontSize: scaleFont(11), textAlign: 'center' },
  discardHint: { color: '#e94560', fontSize: scaleFont(14), textAlign: 'center', paddingVertical: scale(6) },
  waitText: { color: '#b0b0c0', fontSize: scaleFont(14), textAlign: 'center', paddingVertical: scale(6) },

  // Borrow mode
  borrowTitle: { color: '#fff', fontSize: scaleFont(20), fontWeight: 'bold', textAlign: 'center', marginBottom: scale(4) },
  borrowSubtitle: { color: '#b0b0c0', fontSize: scaleFont(13), textAlign: 'center', marginBottom: scale(12) },
  borrowActiveRow: { flexDirection: 'row', alignItems: 'center', gap: scale(12), paddingHorizontal: scale(12), marginBottom: scale(8) },
  borrowGroup: {
    marginHorizontal: scale(12), marginBottom: scale(8), borderRadius: scale(10),
    borderWidth: 2, borderColor: '#334', backgroundColor: '#16213e', padding: scale(8),
  },
  borrowGroupValid: { borderColor: '#4caf50' },
  borrowGroupInvalid: { borderColor: '#e94560' },
  borrowGroupLabel: { color: '#b0b0c0', fontSize: scaleFont(12), marginBottom: scale(6) },
  addGroupBtn: {
    marginHorizontal: scale(12), marginBottom: scale(12), padding: scale(12), borderRadius: scale(10),
    borderWidth: 1.5, borderColor: '#6a1b9a', borderStyle: 'dashed', alignItems: 'center',
  },
  addGroupText: { color: '#b090c8', fontSize: scaleFont(14), fontWeight: 'bold' },
  activeCardInPool: { borderRadius: scale(10), borderWidth: 2, borderColor: '#ffa000' },
