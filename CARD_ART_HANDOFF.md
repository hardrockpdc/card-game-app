...
> 2. Add a **corner index**: the rank in the top-left and bottom-right corners,
>    with a **small suit symbol directly underneath the rank** (bottom-right
>    mirrored/rotated 180°), in addition to the usual large center suit/figure.
> 3. Create a **joker** card in the same style and frame.
>
...
>
> Return all 54 files (55 for the Neon deck — it also has `blank.png`).
