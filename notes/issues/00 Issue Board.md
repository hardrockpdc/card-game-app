...
rows here as of 2026-08-19 (4 `open` + 6 `partial`; CQ-3, CQ-6 and CQ-19 all left this
view on 2026-08-19 — CQ-19 was opened and fixed the same day) that's small enough to
eyeball; click the `severity` column
