...
- [x] **C1** — Add Android + iOS network permissions to `app.json`
...
- [x] **UX4** — Basic card-flip + win sounds (huge perceived quality boost)
...
- [x] **UX2** — First-time tutorial overlays (at least Blackjack + 1 rummy variant)
